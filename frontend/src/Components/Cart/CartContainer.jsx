...
//                 </small>
//                 <h4>
//                     ${cart.reduce((acc, curVal) => acc + curVal.totalPrice, 0)} <sub>(plus tax)</sub>
//                 </h4>
//             </div>
//             <button
//                 onClick={continueToCheckout}
...
//                 <>
//                     {isOpen && (
//                         <div className="fixed bottom-14 inset-x-0 bg-gray-100 z-20 p-2 px-3 lg:px-20 rounded-t-2xl">
...
//                         </div>
//                     )}
//                     <div className="fixed bottom-0 inset-x-0 bg-gray-100 z-10 p-2 px-3 lg:px-20">
//                         <CartData toggle={toggleCart} />
//                     </div>
//                 </>
//             )}
